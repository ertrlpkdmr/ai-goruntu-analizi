"""
Ozel Nesne Tanima - Transfer Learning ile EfficientNet V2 Large
Makine Ogrenmesi Dersi Projesi
Mixup, CutMix, ColorJitter, RandomErasing ile egitim
"""
...
BATCH_SIZE = 32
EPOCHS = 30
FREEZE_EPOCHS = 5  # Ilk 5 epoch sadece classifier egitilir
LR_CLASSIFIER = 1e-3
LR_BACKBONE = 1e-5
NUM_WORKERS = 2
...
MODEL_SAVE_PATH = os.path.join(BASE_DIR, "best_custom_model.pth")

# Mixup / CutMix ayarlari
MIXUP_ALPHA = 0.2
CUTMIX_ALPHA = 1.0
MIXUP_PROB = 0.5
...
# =============================================
# 3. MIXUP VE CUTMIX FONKSIYONLARI
# =============================================
...
# =============================================
# 4. MODEL OLUSTURMA (EfficientNet V2 Large)
# =============================================

print("\nModel yukleniyor (EfficientNet V2 Large - Transfer Learning)...")
model = models.efficientnet_v2_l(weights=models.EfficientNet_V2_L_Weights.IMAGENET1K_V1)

# Son siniflandirici katmani degistir
...
# =============================================
# 5. KAYIP FONKSIYONU VE OPTIMIZER
# =============================================
...
def freeze_backbone(model):
    """Backbone'u dondur, sadece classifier egitilir"""
...
# =============================================
# 6. EGITIM VE TEST FONKSIYONLARI
# =============================================
...
print(f"Model: EfficientNet V2 Large | Epoch: {EPOCHS} | Batch: {BATCH_SIZE}")
print(f"Freeze Epochs: {FREEZE_EPOCHS} | LR classifier: {LR_CLASSIFIER} | LR backbone: {LR_BACKBONE}")
...
# --- FAZE 1: Sadece classifier egitimi ---
...
print(f"En iyi validation dogruluğu: %{best_acc:.2f}")
print(f"Model kaydedildi: {MODEL_SAVE_PATH}")
print("=" * 60)

# =============================================
# 8. SINIF BAZLI DOGRULUK ANALIZI
# =============================================
...
axes[0].set_ylabel("Kayip (Loss)")
axes[0].set_title("Egitim ve Validation Kaybi")
axes[0].legend()
...
axes[1].set_title("Egitim ve Validation Dogrulugu")
axes[1].legend()
axes[1].grid(True, alpha=0.3)

plt.tight_layout()
plt.savefig(os.path.join(BASE_DIR, "custom_training_results.png"), dpi=150)
print("\nGrafik 'custom_training_results.png' olarak kaydedildi.")

# Sinif bazli dogruluk grafigi
...
ax2.set_title("Sinif Bazli Validation Dogrulugu")
ax2.set_xlim(0, 100)
...
plt.tight_layout()
plt.savefig(os.path.join(BASE_DIR, "custom_class_accuracy.png"), dpi=150)
print("Grafik 'custom_class_accuracy.png' olarak kaydedildi.")

# Sinif isimlerini kaydet (app.py icin)
class_names_path = os.path.join(BASE_DIR, "custom_classes.json")
with open(class_names_path, "w", encoding="utf-8") as f:
    json.dump(CLASSES, f, ensure_ascii=False, indent=2)
print(f"Sinif isimleri '{class_names_path}' olarak kaydedildi.")
